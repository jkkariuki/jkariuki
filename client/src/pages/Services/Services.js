...
const Services = () =>
    ...
    <Container id={"servicesContainer"} style={{ marginTop: "0%", backgroundColor: "#efefef" }} fluid>
        ...
        <Row>
            ...
            <Col size="md-6 sm-6">
                <div className="card" style={{ width: "350px", height: "450px", margin: "0px auto" }}>
                    <img class="card-img-top" src={Frontend} style={{ width: "100%", height: "200px", margin: "0px auto" }} alt="Card image" />
            ...
            <Col size="md-6 sm-6">
                <div class="card" style={{ width: "350px", height: "450px", margin: "0px auto" }}>
                    <img class="card-img-top" src={Backend} style={{ width: "100%", height: "200px", margin: "0px auto" }} alt="Card image" />
